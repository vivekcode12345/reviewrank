...
var ReviewRankValidation = (function () {
  ...
  // ratingCount uses the same validation rules.
  ...
  var isValidRatingCount = isValidReviewCount;
  ...
  function normalizeProduct(product) {
    ...
    return {
      ...
      ratingCount: isValidRatingCount(product.ratingCount) ? product.ratingCount : null,
  ...
  // Feedback volume: written review count takes priority, then customer
  // rating count, then null (missing). Used for ranking.
  function getFeedbackVolume(product) {
    if (!product) return null;
    var reviewCount = isValidReviewCount(product.reviewCount) ? product.reviewCount : null;
    if (reviewCount !== null && reviewCount > 0) return reviewCount;
    var ratingCount = isValidRatingCount(product.ratingCount) ? product.ratingCount : null;
  ...
  return {
    ...
    isValidRatingCount: isValidRatingCount,
    isValidImageUrl: isValidImageUrl,
    isEligibleForRanking: isEligibleForRanking,
    normalizeProduct: normalizeProduct,
    validateProducts: validateProducts,
    getFeedbackVolume: getFeedbackVolume
  };
})();
